package com.brainacad.oop.testreflection3;
...
public class Main {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        ...
        Class[] singleIntParam = new Class[]{int.class};
        Constructor myClassContructor = c.getConstructor(singleIntParam);
        MyClass instance = (MyClass) myClassContructor.newInstance(9);

        c.getMethod("setA", singleIntParam).invoke(instance, 8);
        ...
        System.out.println(Arrays.stream(instance.getClass().getDeclaredFields())
                .map(field -> {
                    ...
                    try {
                        fieldDeclaration.append("\t\t\tValue: " + field.get(instance));
